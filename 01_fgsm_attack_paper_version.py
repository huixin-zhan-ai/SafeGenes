...
class TrainingArguments(transformers.TrainingArguments):
    ...
    output_dir: str = field(default="/content/drive/My Drive/vep_FGSM/output_test_arm")
...
class CustomTrainer(Trainer):
    def evaluate_with_fgsm(self, eval_dataset=None, epsilon=0.01):
        ...
        save_path = os.path.join(self.args.output_dir, "fgsm_pllr_results_arm_pgd_10.csv")
